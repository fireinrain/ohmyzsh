...
These gems should not be called with `bundle exec`. Please see [issue #2923](https://ghproxy.com/https://github.com/ohmyzsh/ohmyzsh/pull/2923) on GitHub for clarification:
