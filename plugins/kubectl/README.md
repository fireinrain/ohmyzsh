...
- `kjx`: JSON, colorized with [`fx`](https://ghproxy.com/https://github.com/antonmedv/fx).
- `ky`: YAML, colorized with [`yh`](https://ghproxy.com/https://github.com/andreazorzetto/yh).
