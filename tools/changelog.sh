...
function display-release {
  ...
  function fmt:hash {
    ...
    md) printf '[`%s`](https://ghproxy.com/https://github.com/ohmyzsh/ohmyzsh/commit/%s)' "$hash" ;;
    esac
  }
  ...
  function fmt:subject {
    ...
    md) sed -E 's|#([0-9]+)|[#\1](https://ghproxy.com/https://github.com/ohmyzsh/ohmyzsh/issues/\1)|g' <<< "$subject" ;;
    esac
  }
